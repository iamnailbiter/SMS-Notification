...
$result= mysql_query("SELECT client.*, invoice.* FROM invoice 
      LEFT JOIN client ON invoice.kd_client = client.kd_client
...
<table class="table-list" width="100%">
  <tr>
    <th colspan="3">LAPORAN INVOICE</th>
  </tr>
</table>
          ...
          <tbody class="oetable">
              <?php $nomor=0;while ($row= mysql_fetch_array($result)) {    
                ...
                <tr>
                    ...
                    <td width="100px"><?php echo $KodeInvoice; ?></td>
                    <td width="100px"><?php echo $Kode; ?></td>
