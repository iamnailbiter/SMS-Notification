...
ob_start();
?>
<form name="form1" method="post" action="?cat=master&page=user&act=1">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped">
  ...
  <tr>
    ...
    <td><a href="?cat=master&page=useredit&id=<?php echo sha1($s['username']); ?>">Edit</a> - <a href="?cat=master&page=user&del=1&id=<?php echo sha1($s['username']); ?>">Hapus</a></td>
  </tr>
  <?php
  }
  ?>
