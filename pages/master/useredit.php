...
?>
<form name="form1" method="post" action="?cat=master&page=useredit&id=<?php echo $_GET['id']; ?>&edit=1">
  <table width="50%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" class="btn btn-primary" name="button" id="button" value="Ubah">&nbsp;&nbsp;<input type="button" class="btn btn-danger" name="reset" id="reset" value="Cancel" onclick="window.location='?cat=master&page=user'"></td>
    </tr>
  </table>
</form>
<?php
ob_end_flush();
	...
	echo "<script>window.location='?cat=master&page=user'</script>";
}
?>
<?php
if(isset($_GET['edit']))
