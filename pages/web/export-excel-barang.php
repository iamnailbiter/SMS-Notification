...
$tg1 = (isset($_REQUEST['tgl1']) && !empty($_REQUEST['tgl1']))?$_REQUEST['tgl1']:"";
	...
	$result=mysql_query("SELECT barang_".$fil.".tgl, barang_".$fil.".username, barang_".$fil.".kode_barang, data_barang.nama_barang, data_barang.jenis_barang, barang_".$fil.".jumlah
